<?php
    ...
    $sql = "select * from produto order by descricao";
      // Classifica os atributos em ordem cresc ou desc os atributos
      ...
      <div class="container">
        ...
        <!-- Lista direta do BD******************** -->
          ...
          while ($exibe = mysqli_fetch_array($seleciona)){
            $id = $exibe['id'];
          // faz com que o sql se torne um vetor e exibe quantos valores tem o bd
          ?>
            ...
            <div class="row text-dark text-center ">
                ...
                <div class="col-2 bg-dark-subtle icones ">
                  ...
                  <a href="excluir_produtos.php?id=<?php echo $id?>" onclick="return confirm('Confirma a Exclusão do Registro?')"> <!-- A "?" passa um parâmetro pelo método get --><img src="img/delete.png" alt=""></a></div>
          </div>
        </div>
